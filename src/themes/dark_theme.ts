...
const darkThemeColors: ThemeProperties = {
    ...
    darkGray: '#474747',
    darkerGray: '#666',
    dropdownBackgroundColor: '#24292f',
    ...
    simplifiedTextBoxColor: '#24292f',
    stepsProgressCheckMarkColor: '#24292f',
